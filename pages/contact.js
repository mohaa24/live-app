          ...
          <div className="contact__inner">
            <div className="contact__content">
              ...
              <div className="contact__form">
                ...
                <div>
                  <p>
                    Whether you’re looking to buy, sell, lease or invest, our
                    team is ready to understand your goals across residential,
                    commercial, property management and new projects.
                  </p>
                </div>
                <form name="contact" className="form">
                  <div className="column_left">
                    ...
                    <div className="form__row">
                      <label for="contact-field">Contact Number</label>
                      <input
                        type="text"
                        name="mobile"
                        id="contact-field"
                  ...
                  <div className="column_right">
                    <div className="form__row">
                      <label for="address">Type of Enquiry</label>
